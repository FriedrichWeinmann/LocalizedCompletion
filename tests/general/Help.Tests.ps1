...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\LocalizedCompletion\functions", "$global:testroot\..\LocalizedCompletion\internal\functions"),
	
	[string]
	$ModuleName = "LocalizedCompletion",
...
$CommandPath = @(
    "$global:testroot\..\LocalizedCompletion\functions"
    "$global:testroot\..\LocalizedCompletion\internal\functions"
)
