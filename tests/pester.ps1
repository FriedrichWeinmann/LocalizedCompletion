...
Remove-Module LocalizedCompletion -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\LocalizedCompletion\LocalizedCompletion.psd1"
Import-Module "$PSScriptRoot\..\LocalizedCompletion\LocalizedCompletion.psm1" -Force
